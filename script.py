...
for lists in daily_transactions:
  daily_transactions_split.append(lists.split("++"))
print("DAILY TRANSACTIONS SPLIT:")
print(daily_transactions_split)

transactions_clean = []
for listing in daily_transactions_split:
  clean_trans = []
  for i in listing:
    clean_trans.append(i.replace("\n", "").strip(" "))
  transactions_clean.append(clean_trans)
...
print("WHITE COLOR COUNT:")
print(color_count("white"))

colors = ['red','yellow','green','white','black','blue','purple']
for color in colors:
  print("Thred Shed sold {x} threads of {y} thread today".format(x = color_count(color), y = color))
